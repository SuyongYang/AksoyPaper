...
% data file
datanms = 'DATA_g7_L4_R_mod02_balanced_depy_depo02.xls';

% folder and file names
folder  = 'm_01';
filenms = 'G7_L4_mod_RIR_balanced_depydepo_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 ones(24,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 ones(24,1)'];
...
for ids=1:nsimul
    ...
    %    irfsl(:,:,idh,ids) = irfsl(:,:,idh-1,ids) + irfs(:,:,idh);
    %end
