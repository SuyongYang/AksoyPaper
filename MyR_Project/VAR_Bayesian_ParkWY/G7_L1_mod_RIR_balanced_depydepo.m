...
% data file
datanms = 'DATA_g7_L1_R_mod02_balanced_depy_depo.xls';

% folder and file names
folder  = 'm_01';
filenms = 'G7_L1_mod_RIR_balanced_depydepo_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100 ones(24,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 ones(24,1)'];
