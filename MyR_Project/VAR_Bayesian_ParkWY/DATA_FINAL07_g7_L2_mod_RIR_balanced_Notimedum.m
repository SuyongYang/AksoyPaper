...
% data file
datanms = 'DATA_FINAL07 for PBVAR04_g7_L2_R_mod02_balanced.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DATA_FINAL07 for PBVAR_g7_L2_mod_RIR_balanced_results';
...
%dat = table2array(dat);
%rescale
dat = table2array(dat).*[100 1 100 100 100 100 1 100 100 100 100 1 100 100 100 ones(7,1)'];
...
yx = [-1 20;-.04 .04;-0.1 0.1;-0.1 0.1;-0.05 0.05];
