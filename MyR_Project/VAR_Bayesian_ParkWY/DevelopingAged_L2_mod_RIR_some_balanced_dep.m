...
% data file
datanms = 'DevelopingAged_L2_mod_RIR_some_balanced_DEP.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DevelopingAged_L2_mod_RIR_some_balanced_DEP_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[ 100 1 100 100 100 100 1 100 100 100 100 1 100 100 100  ones(38,1)'];
dat = table2array(dat).*[ 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100  ones(38,1)'];
...
yx = [-.5 1.5;-3 6;-0.3 0.8;-0.3 0.7;-0.9 0.7];
