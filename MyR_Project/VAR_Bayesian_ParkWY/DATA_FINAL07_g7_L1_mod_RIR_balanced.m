...
% data file
datanms = 'DATA_FINAL07 for PBVAR04_g7_L1_R_mod02_balanced.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DATA_FINAL07 for PBVAR_g7_L1_mod_RIR_balanced_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 1 100 100 100 100 1 100 100 100 ones(24,1)'];
%dat = table2array(dat);
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 ones(24,1)'];
...
fc = [1;1;1;1;1];
% yaxis
%yx = [-0.2 0.2;-0.05 0.05;-0.005 0.005;-0.005 0.005;-0.005 0.005];
%rescale
yx = [-1 10;-2 2;-0.1 0.1;-0.1 0.1;-0.05 0.05];
