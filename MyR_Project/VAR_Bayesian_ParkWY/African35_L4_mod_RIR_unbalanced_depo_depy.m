...
% data file
datanms = 'AfricanUnion35_L4_DEPO_DEPY_UB_02.xls';

% folder and file names
folder  = 'm_01';
filenms = 'AfricanUnion35_L4_DEPO_DEPY_UB_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 ones(71,1)'];
%dat = table2array(dat);
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 ones(71,1)'];
