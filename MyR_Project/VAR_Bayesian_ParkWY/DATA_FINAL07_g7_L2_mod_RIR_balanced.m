...
% data file
datanms = 'G7_L2_bal_dep_plm_my.xls';

% folder and file names
folder  = 'm_01';
filenms = 'G7_L2_bal_dep_plm_my_results';
...
varnms = {  'DEP'; 'RGDP';'SAV';'CUR';'RIR'};   
shocknms = {'DEP'; 'RGDP';'SAV';'CUR';'RIR'};
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 1 100 100 100 100 1 100 100 100 100 1 100 100 100 ones(24,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 ones(24,1)'];

%dat = table2array(dat);
%dat = table2array(dat).*[1 1 100 100 100 1 1 100 100 100 1 1 100 100 100 ones(24,1)'];
...
% endogenous variables + constant + exogenous
mk = 10 + 1+ 6 + 17;
%mk   = my*pen;
...
fc = [1;1;1;1;1];
% yaxis
%yx = [-1 1;-0.05 0.05;-0.005 0.005;-0.005 0.005;-0.005 0.005];
%yx = [-.1 .1;-.05 .05;-.05 .05;-.05 .05;-.05 .05];
yx = [-.5 .5;-1 3;-.1 .1;-.1 .1;-.1 .1];

%yx = [-.1 .3;-.04 .04;-0.1 0.1;-0.1 0.1;-0.05 0.05];
