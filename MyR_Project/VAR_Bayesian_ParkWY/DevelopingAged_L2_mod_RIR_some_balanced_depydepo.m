...
% data file
datanms = 'DevelopingAged_L2_mod_RIR_some_balanced_DEPY_DEPO.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DevelopingAged_L2_mod_RIR_some_balanced_DEPY_DEPO_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100  ones(38,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100  ones(38,1)'];
...
yx = [-1.5 1.5;-1.5 1.5;-4 6;-1 1;-1 1;-1 1 ];
