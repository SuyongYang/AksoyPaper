...
% data file
datanms = 'Oecd22_depodepy_L1_mod_RIR_unbalanced.xls';

% folder and file names
folder  = 'm_01';
filenms = 'OECD22_L1_mod_RIR_wholly_unbalanced_depodepy_results';
...
%dat = table2array(dat);
%rescale
dat = table2array(dat).*[ 100 100 1 100 100 100 100 100 1 100 100 100 ones(68,1)'];
if (y_all~=size(dat,1))
