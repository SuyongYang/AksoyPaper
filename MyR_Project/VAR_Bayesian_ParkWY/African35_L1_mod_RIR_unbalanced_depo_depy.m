...
% data file
datanms = 'AfricanUnion35_L1_DEPO_DEPY_UB.xls';

% folder and file names
folder  = 'm_01';
filenms = 'AfricanUnion35_L1_DEPO_DEPY_UB_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100 ones(71,1)'];
%dat = table2array(dat);
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 ones(71,1)'];
...
%yx = [-.5 5;-.2 .2;-.1 .2;-.1 .1;-.1 .1;-.2 .1];
yx = [-1 5;-1 5;-1 2.5;-0.15 0.15;-0.15 .15;-0.15 0.15];
