...
% data file
datanms = 'DATA_g7_L2_R_mod02_balanced_depy_depo.xls';

% folder and file names
folder  = 'm_01';
filenms = 'G7_L2_mod_RIR_balanced_depydepo_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 ones(24,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 ones(24,1)'];
...
%         irfsl(2,:,idh,ids) = irfsl(2,:,idh-1,ids) + irfs(2,:,idh);
% 
%     end
...
vdcmpsumm.p5     = quantile(vdcmp,0.025,4);
vdcmpsumm.p95    = quantile(vdcmp,0.975,4);
...
yx = [-.5 .5;-.5 .5;-4 4;-0.3 0.3;-0.2 0.4;-0.1 0.1];
