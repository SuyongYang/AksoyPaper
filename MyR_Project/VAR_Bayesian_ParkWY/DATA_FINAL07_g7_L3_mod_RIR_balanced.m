...
% data file
datanms = 'DATA_FINAL07 for PBVAR04_g7_L3_R_mod02_balanced.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DATA_FINAL07 for PBVAR_g7_L3_mod_RIR_balanced_results';
...
dat = datt(:,2:45);
%dat = table2array(dat);
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 ones(24,1)'];
