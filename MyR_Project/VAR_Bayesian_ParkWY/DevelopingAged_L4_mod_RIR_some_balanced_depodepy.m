...
% data file
datanms = 'DevelopingAged_L4_mod_RIR_some_balanced_DEPO_DEPY_01.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DevelopingAged_L4_mod_RIR_some_balanced_DEPO_DEPY_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100  ones(38,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100  ones(38,1)'];
...
yx = [-4.4 14;-1.7 1.6;-.1 .16;-0.8 0.8;-0.5 0.9;-1.5 0.9];
