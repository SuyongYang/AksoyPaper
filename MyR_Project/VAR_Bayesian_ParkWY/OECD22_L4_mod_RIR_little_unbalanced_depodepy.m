...
% data file
datanms = 'Oecd22_depodepy_L4_mod_RIR_little_unbalanced01.xls';

% folder and file names
folder  = 'm_01';
filenms = 'OECD22_L4_mod_RIR_little_unbalanced_depodepy_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 ones(31,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 ones(31,1)'];
...
yx = [-5 5;-5 5;-4 4;-0.3 0.2;-0.4 0.2;-0.3 0.2];
