...
% data file
datanms = 'Developing_L2_mod_RIR_wholly_unbalanced_DEP.xls';

% folder and file names
folder  = 'm_01';
filenms = 'Developing_L2_mod_RIR_wholly_unbal_DEP_results';
...
%dat = table2array(dat);
%rescale
dat = table2array(dat).*[  100 1 100 100 100 100 1 100 100 100 100 1 100 100 100  ones(135,1)'];
if (y_all~=size(dat,1))
