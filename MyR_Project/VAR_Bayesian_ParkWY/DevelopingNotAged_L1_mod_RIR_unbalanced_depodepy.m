...
% data file
datanms = 'DevelopingNotAged_L1_mod_RIR_wholly_unbalanced_DEPO_DEPY.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DevelopingNotAged_L1_mod_RIR_wholly_unbalanced_DEPO_DEPY_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 100 1 100 100 100 100 100 1 100 100 100  ones(95,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100  ones(95,1)'];
