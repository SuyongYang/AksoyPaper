...
% data file
datanms = 'DevelopingAged_L2_mod_RIR_wholly_unbalanced_DEP.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DevelopingAged_L2_mod_RIR_wholly_unbalanced_DEP_results';
...
%dat = table2array(dat);
%rescale
dat = table2array(dat).*[  100 1 100 100 100 100 1 100 100 100 100 1 100 100 100  ones(54,1)'];
if (y_all~=size(dat,1))
...
yx = [-0.2 10;-.04 .04;-0.6 0.6;-0.5 0.5;-1.19 .5];
