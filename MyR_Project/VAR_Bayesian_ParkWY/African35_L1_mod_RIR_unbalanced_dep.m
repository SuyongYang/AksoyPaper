...
% data file
datanms = 'AfricanUnion35_L1_DEP_UB.xls';

% folder and file names
folder  = 'm_01';
filenms = 'AfricanUnion35_L1_DEP_UB_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 1 100 100 100 100 1 100 100 100 ones(71,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 ones(71,1)'];
%dat = table2array(dat);
if (y_all~=size(dat,1))
...
yx = [-.1 10;-1 2.5;-0.15 0.15;-0.15 .15;-0.15 0.15];
