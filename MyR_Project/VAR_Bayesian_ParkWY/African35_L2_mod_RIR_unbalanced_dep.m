...
% data file
datanms = 'AfricanUnion35_L2_DEP_UB.xls';

% folder and file names
folder  = 'm_01';
filenms = 'AfricanUnion35_L2_DEP_UB_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 1 100 100 100 100 1 100 100 100 100 1 100 100 100 ones(71,1)'];
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 ones(71,1)'];
%dat = table2array(dat) ;
...
yx = [-1 2;-2 4;-0.5 0.5;-0.5 0.5;-0.5 0.5];
