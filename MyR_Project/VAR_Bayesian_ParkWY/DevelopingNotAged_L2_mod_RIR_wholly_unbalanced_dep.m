...
% data file
datanms = 'DevelopingNotAged_L2_mod_RIR_wholly_unbalanced_DEP.xls';

% folder and file names
folder  = 'm_01';
filenms = 'DevelopingNotAged_L2_mod_RIR_wholly_unbalanced_DEP_results';
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[100 1 100 100 100 100 1 100 100 100 100 1 100 100 100  ones(116,1)'];
%dat = table2array(dat);
dat = table2array(dat).*[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100  ones(116,1)'];
...
yx = [-1 1.5;-2 4;-0.5 0.5;-0.5 0.5;-0.5 0.5];
