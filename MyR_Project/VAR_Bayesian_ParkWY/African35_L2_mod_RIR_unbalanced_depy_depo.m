...
% data file
datanms = 'AfricanUnion35_L2_DEPY_DEPO_UB.xls';

% folder and file names
folder  = 'm_01';
filenms = 'AfricanUnion35_L2_DEPY_DEPO_UB_results';
...
%3; Real price of oil 
% varnms = {  'DEPY';'DEPO';  'lnRgdp';'SAV';'CUR';'RIR'};   
% shocknms = {'DEPY';'DEPO';  'lnRgdp';'SAV';'CUR';'RIR'};
varnms = {  'DEPY';'DEPO';  'RGDP';'SAV';'CUR';'RIR'};   
shocknms = {'DEPY';'DEPO';  'RGDP';'SAV';'CUR';'RIR'};
...
%dat = table2array(dat);
%rescale
%dat = table2array(dat).*[ 100 100 1 100 100 100 100 100 1 100 100 100 100 100 1 100 100 100 ones(71,1)'];
dat = table2array(dat).*[ 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 ones(71,1)'];
%dat = table2array(dat);
...
%yx = [-1 1.5;-1 1.5;-2 6;-1 1;-.8 .6;-1 1];
yx = [-1 2;-1 2;-5 10;-1 1;-0.5 0.5;-1.5 1];

%yx = [-.1 20;-1.5 5;-0.5 0.5;-0.5 0.5;-0.5 0.5];
