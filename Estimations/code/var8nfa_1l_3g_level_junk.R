source('varFunctions_withpi8_rgdp1l_threegroups1l_nfa.R')
...
endo<-list(y="diff(log(RGDPlevel),1)",i="Investment.Rate",s="Savings.Rate",h="log(Hours/Total)",rr="realInterest",rad1="log(PATAPPRESID/(Total*1e3))", nfa_gdp="nfa_gdp", pi="infl")
...
longNames<-list(y = "Growth per Capita",i = "Invest", s = "Saving", h = "Hours",rr = "RealInterest", rad1 = "PATAPPRESID",nfa_gdp="nfa_gdp", pi="Infl")
...
allData<-allData[!(allData$Country %in% c("Germany","Turkey","Australia","Italy", "Greece")),]
#allData<-allData[!(allData$Country %in% c("Germany","Turkey")),]
...
dir.create("../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk",recursive = T, showWarnings = F)

dir.create("../Waldtests/benchmark_3G_pat/3G_pat_nfagdp_level_junk",recursive = T, showWarnings = F)
...
write.table(as.matrix(diagMat),file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/waldprep.csv",row.names = F,col.names = F,sep = ',')
write.table(as.matrix(diagMat),file="../Waldtests/benchmark_3G_pat/3G_pat_nfagdp_level_junk/waldprep.csv",row.names = F,col.names = F,sep = ',')
#printTable(waldtestresults[[name]] ,"../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/waldtestresults.tex")
...
printTable(varMatrices$A1,"Sum of VAR coefficients $A_1","../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/varCoefs.tex")

#printTable(varMatrices$A1 ,"../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/A1matrix.tex")
#printTable(varMatrices$A2 ,"../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/A2matrix.tex")

write.table(varMatrices$A1, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/A1.txt", sep="\t") 
write.table(varMatrices$A1, "../Waldtests/benchmark_3G_pat/3G_pat_nfagdp_level_junk/A1.txt", sep="\t")

#write.table(varMatrices$A2, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/A2.txt", sep="\t") 



# Prepare Correlation Matrix
printTable(corMatrix,digits=3,"Residual Correlation Matrix","../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/correlationMatrix.tex")

# Prepare Covariance Matrix
printTable(covarMatrices,digits=5,"Covariance Matrix","../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/CovarMatrix.tex")

# Prepare Wald Matrix
#printTable(pvcovHCMatrix,digits=5,"Parameter Covariance Matrix","../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/pvcovHC.tex")
...
printTable(varMatrices$D,"Short-Run Demographic Impact","../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/shortRunImpacts.tex")

write.table(varMatrices$D, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/shortD.txt", sep="\t") 
write.table(varMatrices$D, "../Waldtests/benchmark_3G_pat/3G_pat_nfagdp_level_junk/shortD.txt", sep="\t")
...
write.table(longTerm$B, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/B.txt", sep="\t") 
...
printTable(ltD,"Long-Run Demographic Impact",file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/longRunImpacts.tex")

write.table(ltD, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/ltD.txt", sep="\t") 
...
write.table(varMatrices2Ways$A1, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/A12ways.txt", sep="\t") 
write.table(varMatrices2Ways$A1, "../Waldtests/benchmark_3G_pat/3G_pat_nfagdp_level_junk/A12ways.txt", sep="\t")
...
printTable(varMatrices2Ways$D,"Short-Run Demographic Impact","../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/shortRunImpacts2ways.tex")

write.table(varMatrices2Ways$D, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/shortD2ways.txt", sep="\t") 
write.table(varMatrices2Ways$D, "../Waldtests/benchmark_3G_pat/3G_pat_nfagdp_level_junk/shortD2ways.txt", sep="\t")

lt2Ways<-longTermMatrices(varMatrices2Ways)

ltD2<-lt2Ways$D
#ltD <- fixRowNames(fixColNames(ltD))
printTable(ltD2,"Long-Run Demographic Impact (2-way effects)",file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/longRun2ways.tex")
...
diagMat <- bdiag(as.list(exoVarVcovs))
write.table(as.matrix(diagMat),file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/waldprep2ways.csv",row.names = F,col.names = F,sep = ',')
write.table(as.matrix(diagMat),file="../Waldtests/benchmark_3G_pat/3G_pat_nfagdp_level_junk/waldprep2ways.csv",row.names = F,col.names = F,sep = ',')
...
printTable(averagePredictions(),"Average Predicted Impact on GDP Growth by Country",
      file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/averagePredictions.tex", label="tab:avgpredict")

printTable(demoImpactsByCountry(c(unique(allData$Country),"Germany"),1970),"Diﬀerence in Predicted Impact of Demographic Factors between 1970 and 2007",file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/byCountryImpacts.tex")
printTable(demoImpactsByCountry(c(unique(allData$Country),"Germany"),2000),"Diﬀerence in Predicted Impact of Demographic Factors between 2000 and 2007",file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/byCountryImpacts2.tex")

print(longTerm$D,digits=3, sanitize.text.function=function(text){text}, file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/Dmatrix.txt", sep="\t")
...
print(fixRowNames(xtable(coefTable,digits=3,align=rep("r", 1+ncol(coefTable)))),sanitize.text.function=function(text){text}, file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/pcoef.tex")

stdErrTable<-sapply(varModel,function(x){coef(summary(x))[,2]})
print(fixRowNames(xtable(stdErrTable,digits=3,align=rep("r", 1+ncol(stdErrTable)))),sanitize.text.function=function(text){text}, file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/parstdErrs.tex")


coeftestsTable<-lapply(varModel,function(x) coeftest(x,vcov.=function(y) vcovHC(y,"white2", type="HC3")))
print(fixRowNames(xtable(coeftestsTable,digits=3,align=rep("r", 1+ncol(coeftestsTable)))),sanitize.text.function=function(text){text}, file="../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/coeftest.tex")
...
coeftest(varModel$rad1,vcov.=function(y) vcovHC(y,"white2", type="HC3"))
coeftest(varModel$nfa_gdp,vcov.=function(y) vcovHC(y,"white2", type="HC3"))
...
write.table(vcovHC_y, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/bvcov_y.txt", sep="\t") 

vcovHC_i<-vcovHC(varModel$i,method="white2", type="HC3")
write.table(vcovHC_i, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/bvcov_i.txt", sep="\t") 

vcovHC_s<-vcovHC(varModel$s,method="white2", type="HC3")
write.table(vcovHC_s, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/bvcov_s.txt", sep="\t") 

vcovHC_h<-vcovHC(varModel$h,method="white2", type="HC3")
write.table(vcovHC_h, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/bvcov_h.txt", sep="\t") 

vcovHC_rr<-vcovHC(varModel$rr,method="white2", type="HC3")
write.table(vcovHC_rr, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/bvcov_rr.txt", sep="\t") 

vcovHC_rad1<-vcovHC(varModel$rad1,method="white2", type="HC3")
write.table(vcovHC_rad1, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/bvcov_rad1.txt", sep="\t") 

vcovHC_nfa_gdp<-vcovHC(varModel$nfa_gdp,method="white2", type="HC3")
write.table(vcovHC_nfa_gdp, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/bvcov_nfa_gdp.txt", sep="\t") 


vcovHC_pi<-vcovHC(varModel$pi,method="white2", type="HC3")
write.table(vcovHC_pi, "../tex/benchmark_3G_pat/benchmark_pat_nfagdp_level_junk/bvcov_pi.txt", sep="\t") 
