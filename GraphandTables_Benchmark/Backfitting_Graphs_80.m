...
% This code produces Figure 3 in the paper. In sample projections for output,
...
ymax = max(dYCI1(var1,s:TT)+y1)*(1 + sign( max(dYCI1(var1,s:TT)+y1))*0.3);
...
ymax = max(dYCI1(var3,s:TT)+y3)*(1 + sign( max(dYCI1(var3,s:TT)+y3))*0.05);
